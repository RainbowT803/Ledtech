...
ALTER TABLE "public"."demo_favorites" ALTER COLUMN "id" ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME "public"."demo_favorites_id_seq"
    START WITH 1
    INCREMENT BY 1
    MINVALUE 1
    MAXVALUE 9223372036854775807
...
ALTER TABLE ONLY "public"."demo_favorites" ADD CONSTRAINT "demo_favorites_pkey" PRIMARY KEY (id);
...
CREATE TABLE "realtime"."messages" (
    ...
    CONSTRAINT "messages_payload_exclusive" CHECK (payload IS NULL OR binary_payload IS NULL) NOT VALID
);
...
CREATE UNIQUE INDEX "subscription_subscription_id_entity_filters_action_filter_selec" ON "realtime"."subscription" (subscription_id, entity, filters, action_filter, COALESCE(selected_columns, '{}'::text[]));
...
ALTER TABLE "auth"."oauth_authorizations"
    ...
    REFERENCES "auth"."oauth_clients" ("id")
    ON DELETE CASCADE;
...
ALTER TABLE "auth"."webauthn_challenges"
    ADD CONSTRAINT "webauthn_challenges_user_id_fkey" FOREIGN KEY ("user_id")
    REFERENCES "auth"."users" ("id")
    ON DELETE CASCADE;

ALTER TABLE "auth"."webauthn_credentials"
    ADD CONSTRAINT "webauthn_credentials_user_id_fkey" FOREIGN KEY ("user_id")
    REFERENCES "auth"."users" ("id")
    ON DELETE CASCADE;
...
ALTER TABLE "storage"."s3_multipart_uploads_parts"
    ...
    REFERENCES "storage"."s3_multipart_uploads" ("id")
    ON DELETE CASCADE;
